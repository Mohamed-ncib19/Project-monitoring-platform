...
const Portfolio = () => {
  ...
  const handleDelete = (portfolio) =>
    portfolio?.productCount > 0
      ...
      : handleDeleteModalShow(portfolio);
    ...
    <>
          ...
          <div className=" row justify-content-start align-items-center gap-5">
            {portfolios.length > 0 ? (
              ...
              <div className="d-flex flex-column justify-content-center align-items-center gap-3 mt-5">
                ...
                />
                <p className="text-dark-gray text-center fs-3">
                  No portfolio Found
                </p>
              </div>
            )}
      ...
      >
        <p className="text-muted">
          ...
          <b>Products</b>. To delete the Portfolio, you'll need to remove all
          associated Products first.
        </p>
      </AlertModal>
    </>
  );
