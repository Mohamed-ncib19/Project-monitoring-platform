    ...
    <NavbarSideBarLayout>
      <div className="px-3 d-flex flex-column gap-2 col-11 m-auto">
        <div className="" >
          ...
          <p className="light-text-custom-color fw-bold"  >Update your profile and personal details here</p>
        </div>
{loading ? <Loader /> : (
          ...
          <h2 className="fw-bold fs-4  ">Your Photo</h2>
            ...
            <Image
              ...
              <div className="d-flex flex-column align-items-start gap-3 col-12 ">
                ...
                <input type="file"/>
                <p className=" text-soft-black" >The ideal image is 192 x192 pixels. The maximum file size allowed is 200KG</p>
              </div>
            </div>
          ...
          <h2 className="fw-bold fs-4  ">Username</h2>
            <div className="col-lg-6 col-md-7 col-12">
              ...
              <div className="d-flex align-items-center">
                <ReadOnlyInput disabled={true} type={"text"} value={userData?.username} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-2 py-4 border-bottom border-secondary-subtle">
          <div className="col-lg-8 col-md-9 d-flex flex-md-row flex-column justify-content-between align-items-center">
            ...
            <div className="col-lg-6 col-md-7 col-12">
              ...
              <div className="d-flex align-items-center">
                <Textarea register={register('bio')} value={userData?.bio && userData?.bio } errors={errors} placeholder={'Your bio'} name={'bio'} />
              </div>
            </div>
          </div>
        </div>
          ...
          <h2 className="fw-bold fs-4  ">Fullname</h2>
            ...
            <div className="row d-flex justify-content-start  col-8 mx-2">
              <div className="col-4">
                ...
                <div className="d-flex align-items-center">
                <Input  value={userData?.firstname} register={register('firstname')} name='firstname'  errors={errors}  type={"text"} />
                </div>
              </div>
              ...
              <div className="col-4">
                ...
                <div className="d-flex align-items-center">
                  <Input  value={userData?.lastname} register={register('lastname')} name='lastname' errors={errors} type={"text"} />
                </div>
              </div>
            </div>
          </div>
          ...
          <h2 className="fw-bold fs-4  ">Contact information</h2>
            ...
            <div className="row d-flex justify-content-start  col-8 mx-2">
              <div className="col-4">
                ...
                <div className="d-flex align-items-center">
                  <ReadOnlyInput disabled={true} type={"email"} value={userData?.email} />
                </div>
              </div>
              ...
              <div className="col-4">
                ...
                <div className="d-flex align-items-center">
                <Input   register={register('phone')} value={userData?.phone} name="phone" errors={errors}  type={"number"} />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row d-flex justify-content-start  col-8 mx-2">
              <div className="col-4">
                <p className="fs-6 mb-2 py-1 text-soft-black">Business Position</p>
                 <SelectInput hookForm={false} placeholder={userData?.position} disabled={true}  name='position'  />
              </div>

              <div className="col-4">
                <p className="fs-6 mb-2 text-soft-black">User Role</p>
                <div className="d-flex align-items-center">
                  <ReadOnlyInput disabled={true} type={"text"} value={userData?.role} />
                </div>
              </div>
            </div>
          </div>
