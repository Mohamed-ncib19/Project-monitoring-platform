...
const PasswordInput = ({ register, errors, isValid, placeholder }) => {
  ...
  return (
    <div className={`form-group form-floating position-relative w-100 ${errors.password || !isValid ? "is-invalid" : ""}`}>
    <input
        ...
        {...register}
    />
    <label htmlFor="floating-input light-text-custom-color z-0">{placeholder}</label>
