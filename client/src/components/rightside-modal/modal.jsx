...
const CustomModal = ({ show, handleClose, headerTitle, userData, form,edit }) => {
  return (
    <div className="modal bg-danger">
      <Modal show={show} onHide={handleClose} dialogClassName="full-height-modal" contentClassName="full-height-modal-content">
        ...
        <Modal.Body>
          ...
          <div className="modal-alert text-white d-flex justify-content-center align-items-center p-2 gap-2 rounded-5 mt-4">
            <i className="fs-4"><WarningIcon /></i>
            <p className="alert-content">Alert: setting a user's role will adjust their access to information and actions</p>
          </div>
