const ArrowIcons = {
  ...
  ArrowLeftIcon: () => {
    return (
      <i className="text-dark custom-hover-icon fs-2 p-1">
   <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"></path></svg>
      </i>
    );
  },
